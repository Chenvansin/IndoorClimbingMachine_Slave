...
// 		Force set bit to High LEVEL
		...
		if (ucKeyCode != KEY_NONE)
		{
			...
			switch (ucKeyCode)
			{			
				case 1:				/* K1键按下 -- open  1st channel */
					if (MODH_WriteParam_05H(REG_D01, 0xFF00) == 1);else ;
					break;
				
				case 2:				/* K2键按下 -- close 1st channel*/
					if (MODH_WriteParam_05H(REG_D01, 0) == 1) ;else ;
					break;
				
				case 4:				/* K3键按下 -- open  2ed channel */
					if (MODH_WriteParam_05H(REG_D02, 0xFF00) == 1) ;else ;
					break;
				
				case 5:				/* K4键按下 -- close 2ed channel*/
					if (MODH_WriteParam_05H(REG_D02, 0) == 1) ;else ;
					break;				
