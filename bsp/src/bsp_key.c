...
/* 按键口对应的RCC时钟 */
#define RCC_ALL_KEY 	RCC_APB2Periph_GPIOD

#define GPIO_PORT_K1    GPIOD //Valve-1
#define GPIO_PIN_K1	    GPIO_Pin_3

#define GPIO_PORT_K2    GPIOD //Valve-2
...
//{
//	if ((GPIO_PORT_K1->IDR & GPIO_PIN_K1) != 0 && (GPIO_PORT_K2->IDR & GPIO_PIN_K2) != 0
//		&&(GPIO_PORT_K3->IDR & GPIO_PIN_K3) == 0 && (GPIO_PORT_K4->IDR & GPIO_PIN_K4) != 0)
//		return 1;
//	else 
//		return 0;
//}
...
//static uint8_t IsKeyDown3(void) /* K1 K2 同时按下 */
//{
////	if ((GPIO_PORT_K1->IDR & GPIO_PIN_K1) != 0 && (GPIO_PORT_K2->IDR & GPIO_PIN_K2) == 0
