...
#define PIN_RS485_RXEN	 	GPIO_Pin_5

#define RS485_RX_EN()			Clr_RE;Clr_DE;
#define RS485_TX_EN()			Set_RE;Set_DE;

 
/*RE跟GPIOC5管脚相连*/   
#define Set_RE  GPIO_SetBits(PORT_RS485_TXEN,PIN_RS485_RXEN);			 
#define Clr_RE  GPIO_ResetBits(PORT_RS485_TXEN,PIN_RS485_RXEN);
/*DE跟GPIOC4管脚相连*/
#define Set_DE  GPIO_SetBits(PORT_RS485_TXEN,PIN_RS485_TXEN);
#define Clr_DE  GPIO_ResetBits(PORT_RS485_TXEN,PIN_RS485_TXEN);
